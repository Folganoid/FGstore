...
class OrderModel extends Model
{
    ...
    {
        $this->setCase('select');
        $this->setColumns(["o.id", "i.name AS item_name", "o.sum", "i.id AS item_id", "CONCAT(c.name, ' ', c.surname) AS client", "c.id AS client_id", "os.date_order", "os.status", "os.date_send", "os.date_receive", "o.order_status_id"]);
